...
SET ANSI_NULLS ON
GO
CREATE  FUNCTION [Drd].[fn_SumMablaghNaghdi1Variz](@fieldName NVARCHAR(50),@fldReplyTaghsitId int,@fldShomareHesabId int,@AzTarikh nvarchar(10),@Tatarikh nvarchar(10))
RETURNS BIGINT
AS
BEGIN
