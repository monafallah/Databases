...
SET ANSI_NULLS ON
GO
CREATE proc [ACC].[spr_RptMoeenAsli]
...
from(
select distinct d.fldCode,d.fldTitle, fldBedehkar, fldBestankar,d.fldDocumentNum,d.fldTarikhDocument,d.fldDescriptionDocu
