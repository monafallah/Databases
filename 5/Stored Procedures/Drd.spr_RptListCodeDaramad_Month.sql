...
SET ANSI_NULLS ON
GO
CREATE PROC [Drd].[spr_RptListCodeDaramad_Month](@AzTarikh NVARCHAR(10),@TaTarikh NVARCHAR(10),@OrganId INT,@DateType tinyint)
AS
...
DECLARE @temp TABLE(idcode int,Daramadcode NVARCHAR(50),sharhecode NVARCHAR(300),shomareHesab NVARCHAR(50),mablaghcodeDaramad BIGINT,fldtype NVARCHAR(1),hid HIERARCHYID,TarikhPardakht NVARCHAR(10),fldmonth TINYINT)
...
begin
	INSERT INTO @temp
			(idcode, Daramadcode ,sharhecode , shomareHesab , mablaghcodeDaramad,fldtype,hid ,TarikhPardakht,fldMonth )
    ...
    AS fldmablaghCodeDaramad, '0' AS Expr1, tblCodhayeDaramd_1.fldDaramadId,dbo.Fn_AssembelyMiladiToShamsi(fldDatePardakht),CAST(SUBSTRING(dbo.Fn_AssembelyMiladiToShamsi(fldDatePardakht),6,2) AS TINYINT)
...
,fldDaramadId,Tarikh,CAST(fldmonth AS TINYINT)fldmonth
 FROM 
...
,tblCodhayeDaramd_1.fldDaramadId,(dbo.Fn_AssembelyMiladiToShamsi(fldDatePardakht))  AS Tarikh,tblNaghdi_Talab.fldFishId,SUBSTRING(dbo.Fn_AssembelyMiladiToShamsi(fldDatePardakht),6,2) AS fldmonth
FROM            Drd.tblRequestTaghsit_Takhfif INNER JOIN
						...
						AND tblShomareHesabCodeDaramad.fldOrganId=@OrganId
						 ...
						 ,tblNaghdi_Talab.fldShomareHesabId,fldShomareHesab,fldDaramadId,fldDatePardakht,tblNaghdi_Talab.fldFishId,fldAmuzeshParvareshValue,fldTakhfifAmuzeshParvareshValue
...
begin
	...
	SELECT   tblCodhayeDaramd_1.fldid,     tblCodhayeDaramd_1.fldDaramadCode, Drd.tblCodhayeDaramadiElamAvarez.fldSharheCodeDaramad, Com.tblShomareHesabeOmoomi.fldShomareHesab, 
                       ISNULL(cast((Drd.tblCodhayeDaramadiElamAvarez.fldTakhfifAsliValue * Drd.tblCodhayeDaramadiElamAvarez.fldTedad + Drd.tblCodhayeDaramadiElamAvarez.fldTakhfifAvarezValue + Drd.tblCodhayeDaramadiElamAvarez.fldTakhfifMaliyatValue+fldTakhfifAmuzeshParvareshValue)as bigint),
                          cast((Drd.tblCodhayeDaramadiElamAvarez.fldAsliValue * Drd.tblCodhayeDaramadiElamAvarez.fldTedad + Drd.tblCodhayeDaramadiElamAvarez.fldAvarezValue + Drd.tblCodhayeDaramadiElamAvarez.fldMaliyatValue+fldAmuzeshParvareshValue)as bigint))
    AS fldmablaghCodeDaramad, '0' AS Expr1, tblCodhayeDaramd_1.fldDaramadId,fldTarikhVariz,CAST(SUBSTRING(fldTarikhVariz,6,2) AS TINYINT)
    FROM            Drd.tblSodoorFish INNER JOIN
                         Drd.tblSodoorFish_Detail ON Drd.tblSodoorFish.fldId = Drd.tblSodoorFish_Detail.fldFishId INNER JOIN
                         Drd.tblCodhayeDaramadiElamAvarez ON Drd.tblSodoorFish_Detail.fldCodeElamAvarezId = Drd.tblCodhayeDaramadiElamAvarez.fldID INNER JOIN
                         Drd.tblShomareHesabCodeDaramad ON Drd.tblCodhayeDaramadiElamAvarez.fldShomareHesabCodeDaramadId = Drd.tblShomareHesabCodeDaramad.fldId AND 
...
(SELECT   DISTINCT    Drd.tblRequestTaghsit_Takhfif.fldElamAvarezId, tblCodhayeDaramd_1.fldDaramadCode, tblCodhayeDaramd_1.fldid idcode,
	...
	,ISNULL(SUM(fldTakhfifAsliValue*fldTedad+fldTakhfifAvarezValue+fldTakhfifMaliyatValue+fldTakhfifAmuzeshParvareshValue),SUM(fldAsliValue*fldTedad+fldAvarezValue+fldMaliyatValue+fldAmuzeshParvareshValue)) AS fldmablaghCodeDaramad
	,(SELECT TOP(1) ISNULL(SUM(fldTakhfifAsliValue*fldTedad+fldTakhfifAvarezValue+fldTakhfifMaliyatValue+fldTakhfifAmuzeshParvareshValue) OVER (PARTITION BY tblCodhayeDaramadiElamAvarez.fldElamAvarezId),SUM(fldAsliValue*fldTedad+fldAvarezValue+fldMaliyatValue+fldAmuzeshParvareshValue) OVER (PARTITION BY tblCodhayeDaramadiElamAvarez.fldElamAvarezId)) FROM Drd.tblCodhayeDaramadiElamAvarez AS a WHERE a.fldElamAvarezId =Drd.tblRequestTaghsit_Takhfif.fldElamAvarezId) AS fldmablaghKoli
,tblCodhayeDaramd_1.fldDaramadId,fldTarikhVariz  AS Tarikh,tblNaghdi_Talab.fldFishId,SUBSTRING(fldTarikhVariz,6,2) AS fldmonth
FROM            Drd.tblRequestTaghsit_Takhfif INNER JOIN
                         Drd.tblStatusTaghsit_Takhfif ON Drd.tblRequestTaghsit_Takhfif.fldId = Drd.tblStatusTaghsit_Takhfif.fldRequestId INNER JOIN
                         Drd.tblReplyTaghsit ON Drd.tblStatusTaghsit_Takhfif.fldId = Drd.tblReplyTaghsit.fldStatusId INNER JOIN
                         Drd.tblElamAvarez ON Drd.tblRequestTaghsit_Takhfif.fldElamAvarezId = Drd.tblElamAvarez.fldId INNER JOIN
						...
						AND tblShomareHesabCodeDaramad.fldOrganId=@OrganId
						 GROUP BY tblRequestTaghsit_Takhfif.fldElamAvarezId,tblCodhayeDaramd_1.fldDaramadCode, tblCodhayeDaramd_1.fldid,
                         Drd.tblCodhayeDaramadiElamAvarez.fldSharheCodeDaramad,fldMablagh,fldReplyTaghsitId, tblCodhayeDaramadiElamAvarez.fldElamAvarezId
						 ,tblNaghdi_Talab.fldShomareHesabId,fldShomareHesab,fldDaramadId,fldTarikhVariz,tblNaghdi_Talab.fldFishId,fldTakhfifAmuzeshParvareshValue,fldAmuzeshParvareshValue
...
SELECT idcode, fldDaramadCode,fldSharheCodeDaramad,fldShomareHesab, ((CAST(fldMablagh AS BIGINT)*CAST(fldmablaghCodeDaramad AS numeric))/CAST(fldmablaghKoli AS BIGINT)),'2',fldDaramadId ,fldDateStatus,fldMonth
FROM 
(SELECT   DISTINCT    Drd.tblRequestTaghsit_Takhfif.fldElamAvarezId, tblCodhayeDaramd_1.fldDaramadCode, tblCodhayeDaramd_1.fldid idcode,
                         Drd.tblCodhayeDaramadiElamAvarez.fldSharheCodeDaramad
						-- ,SUM(fldMablagh) OVER (PARTITION BY fldReplyTaghsitId,tblNaghdi_Talab.fldShomareHesabId) AS fldMablaghNaghdi
	...
	,ISNULL(SUM(fldTakhfifAsliValue*fldTedad+fldTakhfifAvarezValue+fldTakhfifMaliyatValue+fldTakhfifAmuzeshParvareshValue),SUM(fldAsliValue*fldTedad+fldAvarezValue+fldMaliyatValue+fldAmuzeshParvareshValue)) AS fldmablaghCodeDaramad
	,(SELECT TOP(1) ISNULL(SUM(fldTakhfifAsliValue*fldTedad+fldTakhfifAvarezValue+fldTakhfifMaliyatValue+fldTakhfifAmuzeshParvareshValue) OVER (PARTITION BY tblCodhayeDaramadiElamAvarez.fldElamAvarezId),SUM(fldAsliValue*fldTedad+fldAvarezValue+fldMaliyatValue+fldAmuzeshParvareshValue) OVER (PARTITION BY tblCodhayeDaramadiElamAvarez.fldElamAvarezId)) FROM Drd.tblCodhayeDaramadiElamAvarez AS a WHERE a.fldElamAvarezId =Drd.tblRequestTaghsit_Takhfif.fldElamAvarezId) AS fldmablaghKoli
,tblCodhayeDaramd_1.fldDaramadId,fldDateStatus,CAST(SUBSTRING(fldDateStatus,6,2)AS TINYINT) AS fldMonth,tblCheck.fldid
FROM            Drd.tblRequestTaghsit_Takhfif INNER JOIN
                         Drd.tblStatusTaghsit_Takhfif ON Drd.tblRequestTaghsit_Takhfif.fldId = Drd.tblStatusTaghsit_Takhfif.fldRequestId INNER JOIN
                         Drd.tblReplyTaghsit ON Drd.tblStatusTaghsit_Takhfif.fldId = Drd.tblReplyTaghsit.fldStatusId INNER JOIN
                         Drd.tblElamAvarez ON Drd.tblRequestTaghsit_Takhfif.fldElamAvarezId = Drd.tblElamAvarez.fldId INNER JOIN
						...
						AND (Drd.tblCheck.fldDateStatus ) BETWEEN @AzTarikh AND @TaTarikh
						 ...
						 ,tblCheck.fldShomareHesabIdOrgan,fldShomareHesab,fldDaramadId,fldDateStatus,tblCheck.fldid,fldTakhfifAmuzeshParvareshValue,fldAmuzeshParvareshValue
						 )t


INSERT INTO @temp
       
						 SELECT idcode,  fldDaramadCode,fldSharheCodeDaramad,fldShomareHesab, ((CAST(fldMablagh AS BIGINT)*CAST(fldmablaghCodeDaramad AS numeric))/CAST(fldmablaghKoli AS BIGINT)),'3',fldDaramadId 
						 ,fldDateStatus,t.fldMonth
						 FROM 
(SELECT   DISTINCT    Drd.tblRequestTaghsit_Takhfif.fldElamAvarezId, tblCodhayeDaramd_1.fldDaramadCode, tblCodhayeDaramd_1.fldid idcode,
                         Drd.tblCodhayeDaramadiElamAvarez.fldSharheCodeDaramad
						-- ,SUM(fldMablagh) OVER (PARTITION BY fldReplyTaghsitId,tblNaghdi_Talab.fldShomareHesabId) AS fldMablaghNaghdi
	...
	,ISNULL(SUM(fldTakhfifAsliValue*fldTedad+fldTakhfifAvarezValue+fldTakhfifMaliyatValue+fldTakhfifAmuzeshParvareshValue),SUM(fldAsliValue*fldTedad+fldAvarezValue+fldMaliyatValue+fldAmuzeshParvareshValue)) AS fldmablaghCodeDaramad
	,(SELECT TOP(1) ISNULL(SUM(fldTakhfifAsliValue*fldTedad+fldTakhfifAvarezValue+fldTakhfifMaliyatValue+fldTakhfifAmuzeshParvareshValue) OVER (PARTITION BY tblCodhayeDaramadiElamAvarez.fldElamAvarezId),SUM(fldAsliValue*fldTedad+fldAvarezValue+fldMaliyatValue+fldAmuzeshParvareshValue) OVER (PARTITION BY tblCodhayeDaramadiElamAvarez.fldElamAvarezId)) FROM Drd.tblCodhayeDaramadiElamAvarez AS a WHERE a.fldElamAvarezId =Drd.tblRequestTaghsit_Takhfif.fldElamAvarezId) AS fldmablaghKoli
,tblCodhayeDaramd_1.fldDaramadId,fldDateStatus,CAST(SUBSTRING(fldDateStatus,6,2) AS TINYINT)AS fldMonth
FROM            Drd.tblRequestTaghsit_Takhfif INNER JOIN
                         Drd.tblStatusTaghsit_Takhfif ON Drd.tblRequestTaghsit_Takhfif.fldId = Drd.tblStatusTaghsit_Takhfif.fldRequestId INNER JOIN
                         Drd.tblReplyTaghsit ON Drd.tblStatusTaghsit_Takhfif.fldId = Drd.tblReplyTaghsit.fldStatusId INNER JOIN
                         Drd.tblElamAvarez ON Drd.tblRequestTaghsit_Takhfif.fldElamAvarezId = Drd.tblElamAvarez.fldId INNER JOIN
						...
						AND (Drd.tblSafte.fldDateStatus ) BETWEEN @AzTarikh AND @TaTarikh
						 GROUP BY tblRequestTaghsit_Takhfif.fldElamAvarezId,tblCodhayeDaramd_1.fldDaramadCode,tblCodhayeDaramd_1.fldid, 
                         Drd.tblCodhayeDaramadiElamAvarez.fldSharheCodeDaramad,fldMablaghSanad,fldReplyTaghsitId, tblCodhayeDaramadiElamAvarez.fldElamAvarezId
						 ,tblShomareHesabCodeDaramad.fldShomareHesadId,fldShomareHesab,fldDaramadId,fldDateStatus,fldAmuzeshParvareshValue,fldTakhfifAmuzeshParvareshValue
						 )t

INSERT INTO @temp
SELECT idcode,  fldDaramadCode,fldSharheCodeDaramad,fldShomareHesab, ((CAST(fldMablagh AS BIGINT)*CAST(fldmablaghCodeDaramad AS numeric))/CAST(fldmablaghKoli AS BIGINT)),'4',fldDaramadId 
,fldDateStatus,CAST(fldMonth AS TINYINT)
FROM 
(SELECT   DISTINCT    Drd.tblRequestTaghsit_Takhfif.fldElamAvarezId, tblCodhayeDaramd_1.fldDaramadCode, tblCodhayeDaramd_1.fldid idcode,
                         Drd.tblCodhayeDaramadiElamAvarez.fldSharheCodeDaramad
						-- ,SUM(fldMablagh) OVER (PARTITION BY fldReplyTaghsitId,tblNaghdi_Talab.fldShomareHesabId) AS fldMablaghNaghdi
	...
	,ISNULL(SUM(fldTakhfifAsliValue*fldTedad+fldTakhfifAvarezValue+fldTakhfifMaliyatValue+fldTakhfifAmuzeshParvareshValue),SUM(fldAsliValue*fldTedad+fldAvarezValue+fldMaliyatValue+fldAmuzeshParvareshValue)) AS fldmablaghCodeDaramad
	,(SELECT TOP(1) ISNULL(SUM(fldTakhfifAsliValue*fldTedad+fldTakhfifAvarezValue+fldTakhfifMaliyatValue+fldTakhfifAmuzeshParvareshValue) OVER (PARTITION BY tblCodhayeDaramadiElamAvarez.fldElamAvarezId),SUM(fldAsliValue*fldTedad+fldAvarezValue+fldMaliyatValue+fldAmuzeshParvareshValue) OVER (PARTITION BY tblCodhayeDaramadiElamAvarez.fldElamAvarezId)) FROM Drd.tblCodhayeDaramadiElamAvarez AS a WHERE a.fldElamAvarezId =Drd.tblRequestTaghsit_Takhfif.fldElamAvarezId) AS fldmablaghKoli
,tblCodhayeDaramd_1.fldDaramadId,fldDateStatus,SUBSTRING(fldDateStatus,6,2) AS fldMonth
FROM            Drd.tblRequestTaghsit_Takhfif INNER JOIN
                         Drd.tblStatusTaghsit_Takhfif ON Drd.tblRequestTaghsit_Takhfif.fldId = Drd.tblStatusTaghsit_Takhfif.fldRequestId INNER JOIN
                         Drd.tblReplyTaghsit ON Drd.tblStatusTaghsit_Takhfif.fldId = Drd.tblReplyTaghsit.fldStatusId INNER JOIN
                         Drd.tblElamAvarez ON Drd.tblRequestTaghsit_Takhfif.fldElamAvarezId = Drd.tblElamAvarez.fldId INNER JOIN
...
SELECT SUM(mablaghcodeDaramad) Mablagh,ISNULL(fldmonth,'') fldmonth,com.fn_month(fldmonth) AS fldNameMah FROM @temp where mablaghcodeDaramad<>0
GROUP BY fldmonth
...
--DECLARE @temp2 TABLE(hidChilde NVARCHAR(50),DaramadCodeChilde NVARCHAR(50),DaramdTitleChilde NVARCHAR(max),lvlChilde NVARCHAR(10),P_hid NVARCHAR(50),P_DaramadCode NVARCHAR(50),P_DaramadTitle NVARCHAR(MAX),P_Level NVARCHAR(50),Mablagh INT,fldShomareHesab NVARCHAR(50),fldShomareHesabId INT ,LastNode  NCHAR(2))
--INSERT INTO @temp2
--SELECT * from (SELECT fldStrhid AS hidChilde,fldDaramadCode AS DaramdCodeChilde,ISNULL((SELECT sharhecode FROM @temp WHERE Daramadcode=C.fldDaramadCode),fldDaramadTitle)  AS DaramadTitleChilde,fldLevel AS lvlChilde,
...
--,ISNULL((SELECT SUM(mablaghcodeDaramad) FROM @temp WHERE Daramadcode=C.fldDaramadCode GROUP BY fldmonth) ,ISNULL((SELECT SUM(mablaghcodeDaramad) FROM @temp AS t WHERE t.hid.ToString() LIKE c.fldStrhid+'%' GROUP by fldmonth),0)) AS Mablagh
...
-- ,(SELECT  TOP(1)  fldShomareHesadId FROM  Drd.tblShomareHesabCodeDaramad WHERE fldCodeDaramadId=fldId AND fldOrganId=@OrganId) fldShomareHesabId
...
--  ,(SELECT fldmonth FROM @temp WHERE Daramadcode=C.fldDaramadCode GROUP BY fldmonth)   fldmonth            
