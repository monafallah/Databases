...
SET ANSI_NULLS ON
GO
CREATE PROC [Pay].[spr_tblMohasebat_ItemsSelect] 
...
AS 
	...
	if (@fieldname=N'fldId')
		SELECT top(@h) i.[fldId], i.[fldMohasebatId],i.[fldItemEstekhdamId], i.[fldMablagh], i.[fldUserId],i.[fldDesc], i.[fldDate] ,h.fldTitle
	FROM   [Pay].[tblMohasebat_Items]  as i
