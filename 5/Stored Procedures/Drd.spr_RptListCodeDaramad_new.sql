...
SET ANSI_NULLS ON
GO
CREATE PROC [Drd].[spr_RptListCodeDaramad_new](@AzTarikh NVARCHAR(10),@TaTarikh NVARCHAR(10),@ShomareHesabId INT,@CodeDaramadId INT,@OrganId INT,@fieldname NVARCHAR(50))
AS
...
BEGIN
	...
	------------------------------------------------------- وصول شده
			...
			SELECT  (select fldStrhid from drd.tblCodhayeDaramd where fldid=@CodeMaliyat) AS hidChilde,(select tblCodhayeDaramd.fldDaramadCode from drd.tblCodhayeDaramd where fldid=@CodeMaliyat) AS DaramdCodeChilde,N'مالیات' AS DaramadTitleChilde
...
BEGIN
		...
		BEGIN
			INSERT INTO @temp
			SELECT        tblCodhayeDaramd_1.fldDaramadCode, Drd.tblCodhayeDaramadiElamAvarez.fldSharheCodeDaramad, Com.tblShomareHesabeOmoomi.fldShomareHesab, 
								   ISNULL(cast((Drd.tblCodhayeDaramadiElamAvarez.fldTakhfifAsliValue * Drd.tblCodhayeDaramadiElamAvarez.fldTedad)as bigint),
									  cast((Drd.tblCodhayeDaramadiElamAvarez.fldAsliValue * Drd.tblCodhayeDaramadiElamAvarez.fldTedad)as bigint))
			...
			WHERE tblSodoorFish.fldId NOT IN (SELECT fldFishId FROM Drd.tblEbtal WHERE fldFishId=tblSodoorFish.fldId)
								 ...
								 AND tblShomareHesabCodeDaramad.fldOrganId=@OrganId
        union all--مالیات
		SELECT        (select fldDaramadCode from drd.tblCodhayeDaramd where fldid=@CodeMaliyat), Drd.tblCodhayeDaramadiElamAvarez.fldSharheCodeDaramad, Com.tblShomareHesabeOmoomi.fldShomareHesab, 
			...
			WHERE tblSodoorFish.fldId NOT IN (SELECT fldFishId FROM Drd.tblEbtal WHERE fldFishId=tblSodoorFish.fldId)
								 ...
								 AND tblShomareHesabCodeDaramad.fldOrganId=@OrganId
		union all--عوارض
		SELECT       (select fldDaramadCode from drd.tblCodhayeDaramd where fldid=@CodeAvarez), Drd.tblCodhayeDaramadiElamAvarez.fldSharheCodeDaramad, Com.tblShomareHesabeOmoomi.fldShomareHesab, 
		...
		(SELECT   DISTINCT    Drd.tblRequestTaghsit_Takhfif.fldElamAvarezId, tblCodhayeDaramd_1.fldDaramadCode, 
								...
								,fldShomareHesab ,fldReplyTaghsitId
			,ISNULL(SUM(fldTakhfifAsliValue*fldTedad),SUM(fldAsliValue*fldTedad)) AS fldmablaghCodeDaramad
			,(SELECT TOP(1) ISNULL(SUM(fldTakhfifAsliValue*fldTedad+fldTakhfifAvarezValue+fldTakhfifMaliyatValue) OVER (PARTITION BY tblCodhayeDaramadiElamAvarez.fldElamAvarezId),SUM(fldAsliValue*fldTedad+fldAvarezValue+fldMaliyatValue) OVER (PARTITION BY tblCodhayeDaramadiElamAvarez.fldElamAvarezId)) FROM Drd.tblCodhayeDaramadiElamAvarez AS a WHERE a.fldElamAvarezId =Drd.tblRequestTaghsit_Takhfif.fldElamAvarezId) AS fldmablaghKoli
		...
		,fldDaramadId,'',0,fldShomareHesabId	,fldMaliyatValue,fldAvarezValue
		 FROM 
		(SELECT   DISTINCT    Drd.tblRequestTaghsit_Takhfif.fldElamAvarezId,(select fldDaramadCode from drd.tblCodhayeDaramd where fldid=@CodeMaliyat)as fldDaramadCode, 
								 Drd.tblCodhayeDaramadiElamAvarez.fldSharheCodeDaramad
								,Drd.fn_SumMablaghNaghdi1('Naghdi_Talab',tblNaghdi_Talab.fldFishId,tblNaghdi_Talab.fldShomareHesabId,@azTarikh ,@Tatarikh) AS fldMablaghNaghdi
								,fldShomareHesab ,fldReplyTaghsitId
		...
		FROM            Drd.tblRequestTaghsit_Takhfif INNER JOIN
								...
								AND tblShomareHesabCodeDaramad.fldOrganId=@OrganId
								 ...
								 ,tblNaghdi_Talab.fldShomareHesabId,fldShomareHesab,fldDaramadId,Drd.tblNaghdi_Talab.fldShomareHesabId 
									,fldMaliyatValue,fldAvarezValue,fldTakhfifMaliyatValue,fldTakhfifAvarezValue,tblNaghdi_Talab.fldFishId
								 )t where fldmablaghKoli<>0
		union all--عوارض
		SELECT fldDaramadCode,fldSharheCodeDaramad,fldShomareHesab,cast(cast(fldMablaghNaghdi as decimal(50))*cast(fldmablaghCodeDaramad as decimal(50))/cast(fldmablaghKoli as decimal(50))as bigint),'1'
		,fldDaramadId,'',0,fldShomareHesabId	,fldMaliyatValue,fldAvarezValue
		 FROM 
		(SELECT   DISTINCT    Drd.tblRequestTaghsit_Takhfif.fldElamAvarezId, (select fldDaramadCode from drd.tblCodhayeDaramd where fldid=@CodeAvarez)as fldDaramadCode, 
								 Drd.tblCodhayeDaramadiElamAvarez.fldSharheCodeDaramad
								,Drd.fn_SumMablaghNaghdi1('Naghdi_Talab',tblNaghdi_Talab.fldFishId,tblNaghdi_Talab.fldShomareHesabId,@azTarikh ,@Tatarikh) AS fldMablaghNaghdi
								,fldShomareHesab ,fldReplyTaghsitId
		...
		FROM            Drd.tblRequestTaghsit_Takhfif INNER JOIN
		 ...
		 IF(@ShomareHesabId<>0 AND @CodeMaliyat=@CodeDaramadId)
					SELECT DISTINCT hidChilde,DaramdCodeChilde,DaramadTitleChilde,lvlChilde,P_hid,P_DaramadCode,P_DaramadTitle,P_Level,sum(Mablagh)   Mablagh
