...
SET ANSI_NULLS ON
GO
CREATE PROC [Drd].[spr_RptListCodeDaramad_Gaje](@FieldName NVARCHAR(50),@AzTarikh NVARCHAR(10),@TaTarikh NVARCHAR(10),@value NVARCHAR(50),@OrganId INT)
AS
...
SELECT    tblCodhayeDaramd_1.fldid,    tblCodhayeDaramd_1.fldDaramadCode, Drd.tblCodhayeDaramadiElamAvarez.fldSharheCodeDaramad, Com.tblShomareHesabeOmoomi.fldShomareHesab, 
                       ISNULL((Drd.tblCodhayeDaramadiElamAvarez.fldTakhfifAsliValue * Drd.tblCodhayeDaramadiElamAvarez.fldTedad + Drd.tblCodhayeDaramadiElamAvarez.fldTakhfifAvarezValue + Drd.tblCodhayeDaramadiElamAvarez.fldTakhfifMaliyatValue+fldTakhfifAmuzeshParvareshValue),
                          (Drd.tblCodhayeDaramadiElamAvarez.fldAsliValue * Drd.tblCodhayeDaramadiElamAvarez.fldTedad + Drd.tblCodhayeDaramadiElamAvarez.fldAvarezValue + Drd.tblCodhayeDaramadiElamAvarez.fldMaliyatValue+fldAmuzeshParvareshValue))
...
union all
SELECT idcode, fldDaramadCode,fldSharheCodeDaramad,fldShomareHesab, (CAST((CAST(fldMablaghNaghdi AS BIGINT)*CAST(fldmablaghCodeDaramad AS bigint))AS BIGINT)/CAST(fldmablaghKoli AS bigint)),'1'
,fldDaramadId
 FROM 
...
FROM            Drd.tblRequestTaghsit_Takhfif INNER JOIN
						...
						AND tblShomareHesabCodeDaramad.fldOrganId=@OrganId
						 ...
						 ,tblNaghdi_Talab.fldShomareHesabId,fldShomareHesab,fldDaramadId,tblNaghdi_Talab.fldFishId
...
SELECT  idcode,fldDaramadCode,fldSharheCodeDaramad,fldShomareHesab, (CAST((CAST(fldMablagh AS BIGINT)*CAST(fldmablaghCodeDaramad AS bigint))AS BIGINT)/CAST(fldmablaghKoli AS BIGINT)),'2',fldDaramadId FROM 
(SELECT   DISTINCT    Drd.tblRequestTaghsit_Takhfif.fldElamAvarezId, tblCodhayeDaramd_1.fldDaramadCode, tblCodhayeDaramd_1.fldid idcode,
                         Drd.tblCodhayeDaramadiElamAvarez.fldSharheCodeDaramad
						-- ,SUM(fldMablagh) OVER (PARTITION BY fldReplyTaghsitId,tblNaghdi_Talab.fldShomareHesabId) AS fldMablaghNaghdi
...
FROM            Drd.tblRequestTaghsit_Takhfif INNER JOIN
						...
						AND tblShomareHesabCodeDaramad.fldOrganId=@OrganId
						 ...
						 ,tblCheck.fldShomareHesabIdOrgan,fldShomareHesab,fldDaramadId,tblCheck.fldid,fldTakhfifAmuzeshParvareshValue,fldAmuzeshParvareshValue
						 )t


INSERT INTO @temp
       
						 SELECT idcode, fldDaramadCode,fldSharheCodeDaramad,fldShomareHesab, (CAST((CAST(fldMablagh AS BIGINT)*CAST(fldmablaghCodeDaramad AS bigint))AS BIGINT)/CAST(fldmablaghKoli AS BIGINT)),'3',fldDaramadId FROM 
(SELECT   DISTINCT    Drd.tblRequestTaghsit_Takhfif.fldElamAvarezId, tblCodhayeDaramd_1.fldDaramadCode, tblCodhayeDaramd_1.fldid idcode,
                         Drd.tblCodhayeDaramadiElamAvarez.fldSharheCodeDaramad
						-- ,SUM(fldMablagh) OVER (PARTITION BY fldReplyTaghsitId,tblNaghdi_Talab.fldShomareHesabId) AS fldMablaghNaghdi
...
INSERT INTO @temp
SELECT idcode, fldDaramadCode,fldSharheCodeDaramad,fldShomareHesab, (CAST((CAST(fldMablagh AS BIGINT)*CAST(fldmablaghCodeDaramad AS bigint))AS BIGINT)/CAST(fldmablaghKoli AS BIGINT)),'4',fldDaramadId FROM 
(SELECT   DISTINCT    Drd.tblRequestTaghsit_Takhfif.fldElamAvarezId, tblCodhayeDaramd_1.fldDaramadCode, tblCodhayeDaramd_1.fldid idcode,
                         Drd.tblCodhayeDaramadiElamAvarez.fldSharheCodeDaramad
						-- ,SUM(fldMablagh) OVER (PARTITION BY fldReplyTaghsitId,tblNaghdi_Talab.fldShomareHesabId) AS fldMablaghNaghdi
...
INSERT INTO @temp2
SELECT * from (SELECT fldStrhid AS hidChilde,fldDaramadCode AS DaramdCodeChilde,ISNULL((SELECT MAX(sharhecode) FROM @temp WHERE idcode=C.fldid GROUP BY idcode ),fldDaramadTitle)  AS DaramadTitleChilde,fldLevel AS lvlChilde,
...
IF(@FieldName='')
SELECT (SELECT TOP(1) Mablagh FROM @temp2 ORDER BY Mablagh desc)   AS MaxMablagh,(SELECT TOP(1) DaramadCodeChilde FROM @temp2 ORDER BY Mablagh desc)  MaxDaramadCodeChilde,
(SELECT TOP(1) DaramdTitleChilde FROM @temp2 ORDER BY Mablagh desc) MaxDaramdTitleChilde,
(SELECT TOP(1) Mablagh FROM @temp2 ORDER BY Mablagh ASC)   AS MinMablagh,(SELECT TOP(1) DaramadCodeChilde FROM @temp2 ORDER BY Mablagh asc) MinDaramadCodeChilde,
(SELECT TOP(1) DaramdTitleChilde FROM @temp2 ORDER BY Mablagh ASC)MinDaramdTitleChilde,
(SELECT TOP(1) Mablagh FROM @temp2 ORDER BY P_DaramadCode ASC)   AS Mablagh,(SELECT TOP(1) DaramadCodeChilde FROM @temp2 ORDER BY P_DaramadCode asc) DaramadCodeChilde,
(SELECT TOP(1) DaramdTitleChilde FROM @temp2 ORDER BY P_DaramadCode ASC)DaramdTitleChilde

IF(@FieldName='CodeDaramd')
SELECT (SELECT TOP(1) Mablagh FROM @temp2 ORDER BY Mablagh desc)   AS MaxMablagh,(SELECT TOP(1) DaramadCodeChilde FROM @temp2 ORDER BY Mablagh desc)  MaxDaramadCodeChilde,
(SELECT TOP(1) DaramdTitleChilde FROM @temp2 ORDER BY Mablagh desc) MaxDaramdTitleChilde,
(SELECT TOP(1) Mablagh FROM @temp2 ORDER BY Mablagh ASC)   AS MinMablagh,(SELECT TOP(1) DaramadCodeChilde FROM @temp2 ORDER BY Mablagh asc) MinDaramadCodeChilde,
(SELECT TOP(1) DaramdTitleChilde FROM @temp2 ORDER BY Mablagh ASC)MinDaramdTitleChilde,
(SELECT  Mablagh FROM @temp2 WHERE DaramadCodeChilde=@value)   AS Mablagh,(SELECT DaramadCodeChilde FROM @temp2 WHERE DaramadCodeChilde=@value) DaramadCodeChilde,
(SELECT DaramdTitleChilde FROM @temp2 WHERE DaramadCodeChilde=@value)DaramdTitleChilde
GO
