...
SET ANSI_NULLS ON
GO
CREATE PROC [Pay].[spr_tblMohasebatEzafeKari_TatilKariInsert] 
...
AS 
	...
	SELECT @IdMohasebat,NULL,NULL,@fldID,NULL,NULL,@fldCostCenterId,@fldInsurance,@JobCode,@TypeBime,@AnvaEstekhdam,@fldFiscalHeaderId,@fldMoteghayerHoghoghiId,@fldShomareHesabId,@ShomareBime,@Sh_hesabPasAndaz,@Sh_hesabPasKarFarma,
