...
SET ANSI_NULLS ON
GO
create PROC [Pay].[spr_tblMotalebateParametriDeactive_PersonalUpdate] 
...
AS 
	...
	AND fldParametrId=@fldParametrId AND fldMablagh=@fldMablagh AND fldTarikhPardakht=@fldTarikhePardakht
	COMMIT TRAN
GO
