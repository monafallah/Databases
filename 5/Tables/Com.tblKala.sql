...
GO
ALTER TABLE [Com].[tblKala] ADD CONSTRAINT [PK_tblKala_1] PRIMARY KEY CLUSTERED ([fldId]) ON [PRIMARY]
GO
ALTER TABLE [Com].[tblKala] ADD CONSTRAINT [IX_tblKala_2] UNIQUE NONCLUSTERED ([fldName], [fldOrganId]) ON [PRIMARY]
GO
ALTER TABLE [Com].[tblKala] ADD CONSTRAINT [FK_tblKala_tblMeasureUnit] FOREIGN KEY ([fldVahedAsli]) REFERENCES [Com].[tblMeasureUnit] ([fldId])
GO
ALTER TABLE [Com].[tblKala] ADD CONSTRAINT [FK_tblKala_tblMeasureUnit1] FOREIGN KEY ([fldVahedFaree]) REFERENCES [Com].[tblMeasureUnit] ([fldId])
GO
ALTER TABLE [Com].[tblKala] ADD CONSTRAINT [FK_tblKala_tblOrganization] FOREIGN KEY ([fldOrganId]) REFERENCES [Com].[tblOrganization] ([fldId])
GO
ALTER TABLE [Com].[tblKala] ADD CONSTRAINT [FK_tblKala_tblUser] FOREIGN KEY ([fldUserId]) REFERENCES [Com].[tblUser] ([fldId])
GO
