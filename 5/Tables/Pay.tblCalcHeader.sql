CREATE TABLE [Pay].[tblCalcHeader]
(
...
GO
ALTER TABLE [Pay].[tblCalcHeader] ADD CONSTRAINT [PK_tblCalcHeader] PRIMARY KEY CLUSTERED ([fldId]) ON [PRIMARY]
GO
ALTER TABLE [Pay].[tblCalcHeader] ADD CONSTRAINT [FK_tblCalcHeader_tblUser] FOREIGN KEY ([fldUserId]) REFERENCES [Com].[tblUser] ([fldId])
GO
